							...
							@else
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{asset('storage/photo/'.$p->prdpht)}}" alt="IMG-PRODUCT">
											<a href="#" data-toggle="modal" data-target="#prevModal{{$p->IDCar}}" style="text-decoration:none; color:inherit;" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">Quick View</a>
										</div>
										<div class="block2-txt flex-w flex-t p-t-14">
											<div class="block2-txt-child1 flex-col-l ">

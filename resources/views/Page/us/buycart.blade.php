...
<head>
	...
	<!--===============================================================================================-->
	<style>
		th{text-align:center;border: 1px solid;}
		td{
			text-align:center;
			align-items:center;
			padding:1%;
					...
					<div class="m-l-25 m-r--38 m-lr-0-xl">
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
								...
								<tr class="table_row">
									<td class="column-1"><div class="how-itemcart1"><img src="{{asset('storage/photo/'.$p->prdpht)}}" alt="IMG"></div></td>
									<td class="column-2">{{$p->name}}</td>
									<td class="column-3">Rp{{ number_format($p->price, 2, ',', '.') }}</td>
									<td class="column-5" rowspan="2">{{$p->price}}</td>
								</tr>
								<tr class="table_row">
									<td colspan="3" style="text-align:left;">
										<fieldset>
											...
											<div class="form-group">
												Biaya Jasa & Aplikasi<input type="text" class="form-control" name="send" id="send" placeholder="Biaya Jasa & Aplikasi" disabled>
											</div>
											<div class="form-group">
											...
											<div class="form-group form-inline"> 
												<input type="text" class="form-control" name="usid" required="required" placeholder="Total" style="margin-right: 10px;" value="{{ $userString }}" hidden>
											</div>
										</fieldset>
									</td>
								</tr>
				...
				<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
					<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
						...
						<div class="flex-w flex-t bor12 p-b-13">
							...
							<div class="size-209">
								<span class="mtext-110 cl2">$39.00</span>
							</div>
						</div>
